# Round 3 — six treatments

**Date:** 2026-08-30  
**Count lock:** Six. Named by the visual *move*, not by a room.  
**Not the production site.** Living mocks exist so the 2026 techniques can be felt. Stills are the first viewport.
...
|---|---|---|---|
| [01](01-kinetic-headline.md) | Kinetic Headline | The words change weight as she nears the button | She is type-literate; giant true words beat a photograph |
| [02](02-scroll-reveal-faces.md) | Scroll-Reveal Faces | Two people look at her as the page opens | Faces were the mechanism that landed three prior rounds; arrival is the event |
| [03](03-depth-field.md) | Depth Field | Planes occupy space, not a card on a page | Prior rounds were flat. Depth is the 2026 gap |
| [04](04-sticky-thumb.md) | Sticky Thumb | The button is already in her thumb | A busy woman should not hunt for the act |
| [05](05-masked-type.md) | Masked Type | The words *are* the faces | One object, two jobs. Magazine craft she already trusts |
| [06](06-asymmetric-bento.md) | Asymmetric Bento | An editorial spread, not a template | Uneven tiles. The stamp is equal to a photograph |
...
- Last three (as of 2026-08-30 feed):
  1. *$40 Trillion Debt, and Six AI Executives Holding Up the Economy*
  2. *Rethinking Rent: Ownership Through Community Care (Full)*
  3. *Owning What You Rent — Policy, Tax, and the Lightning Round*
  Hub: https://lnk.to/sappod

## Open fills (placed, not invented)

- Cookie policy URL
- California opt-out URL
- Privacy / terms URLs
- Newsletter destination
- Guest names for “who sat in the chair”
- The specific civic act beyond “this week’s last three”
